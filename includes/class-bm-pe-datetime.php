<?php
/**
 * Press Events Wrapper for PHP DateTime which adds support for gmt/utc offset when a
 * timezone is absent.
 *
 * @since 1.0.0
...
class BM_PE_DateTime extends DateTime {
	...
	/**
	 * Output an ISO 8601 date string in local (WordPress or event) timezone.
	 *
     * @since 1.0.0
	 * @return string
	 */
	...
	/**
	 * Get the timestamp with the WordPress or event timezone offset added or subtracted.
	 *
     * @since 1.0.0
	 * @return int
	 */
